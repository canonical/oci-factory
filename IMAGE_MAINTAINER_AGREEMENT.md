...
- **if** the Ubuntu ROCK has `.deb` packages from the Ubuntu archives, then it **must** include a security manifest `/usr/share/rocks/dpkg.query`. It can be generated by
