...
class GenerateOciYaml:
    ...
    Attributes:
        ...
        - all_revision_tags (path): File w/ comma-separated list of all revision tags.
    ...
    def get_canonical_tags(
        all_tags_by_revision: Dict, track_by_revision: Dict, key_to_search: str
    ) -> str:
        """
    ...
    def build_releases_data(
        self,
        group_by_revision: Dict,
        revision_to_track: Dict,
    ) -> List[Dict]:
