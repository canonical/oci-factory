...
# mkdir -p ubuntu-base
# tar -xf $oci_archive_name -C ubuntu-base
...
echo "Publishing to registries with tags: ${UBUNTU_TAGS[@]}"

# With every published image, we also need to publish the corresponding docs
# Note that this is only applicable for discoverable registries (i.e DH and ECR)
